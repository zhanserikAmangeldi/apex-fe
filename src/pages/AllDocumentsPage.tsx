            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 py-12">
                <div className="mb-8">
                    ...
                    <input
                        ...
                        className="w-full max-w-md px-4 py-3 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all"
                    />
                </div>
                            ...
                            <GlassCard key={doc.id}>
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <button
                                        ...
                                        className="px-6 py-3 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-sm font-medium transition-all"
                                    >
                                        Open
                                    </button>
                                </div>
